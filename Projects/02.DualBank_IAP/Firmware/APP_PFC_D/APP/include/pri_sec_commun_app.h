...
#define CMD_LLC_ENTER_IAP         0xFF    // 命令字：进入IAP
#define CMD_IAP_PREPARE           0xAB    // 新协议：准备进入IAP
#define CMD_IAP_READY             0xBA    // 新协议：确认ID和事务序号
#define CMD_IAP_RESET             0x5A    // 新协议：确认后复位
#define CMD_IAP_REJECT            0xA5    // 新协议：ID、序号或状态错误
