...
void llc_filter()
{
  llc.vout_value 	= (llc.vout_value_store[0]) / VOUT_FILTER_ORDER *1.106f+0.13f;
...
//      tx_vofa_data.f[1] = llc.iout_rel;
//      tx_vofa_data.f[2] =	llc.vbus_ref	;
//      tx_vofa_data.f[3] = llc.loop_out ; 
//      tx_vofa_data.f[4] = llc.period;
//      tx_vofa_data.f[5] = llc.vloop.loop_out;
//      tx_vofa_data.f[6] = llc.vout_trim_delta;
//      tx_vofa_data.f[7] =	llc.vloop.kp;
//			tx_vofa_data.f[8] = llc.vout_trim;//llc.R_Out_ratio;
//			tx_vofa_data.f[9] = llc.s_trim_value;
...
//      tx_vofa_data.f[3] = llc.loop_out ; 
//      tx_vofa_data.f[4] = llc.period;
//      tx_vofa_data.f[5] = llc.duty;
//      tx_vofa_data.f[6] = llc.switch_mode;
//      tx_vofa_data.f[7] =	llc.burst_cnt;
