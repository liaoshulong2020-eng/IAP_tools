...
void cmp_init_app()
{
    ...
    user_cmp_init.posi_in_src = CMP_POSI_IN_SRC_CMP_INP0;//PB0 OVP
    LL_CMP_Init(CMP3, &user_cmp_init);
	
	
		user_cmp_init.neg_in_src = CMP_NEG_IN_SRC_DACy_OUT;  //DAC3_OUT
	  user_cmp_init.posi_in_src = CMP_POSI_IN_SRC_CMP_INP0;//PA0 OCP
    LL_CMP_Init(CMP2, &user_cmp_init);
